        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <input
                        type="text"
                        {...register("username", { required: true, pattern: '^[A-Za-z0-9]{3,16}$' })}
                ...
                >
                    ...
                    <input
                        type="password"
                        {...register("password", { required: true, pattern: "^(?=.*[0-9])(?=.*[a-zA-Z])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{8,20}$" })}
                        aria-invalid={errors.firstName ? "true" : "false"}
                        className="invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer w-[405px] px-4 h-11 border border-slate-500 rounded focus:border-sky-600 focus:outline-none focus:ring focus:ring-sky-400 focus:ring-opacity-40"
                        placeholder="Username"
                    />
                ...
                >
                    ...
                    <input
                        type="password"
                        {...register("re-password", { required: true, pattern: '^(?=.*[0-9])(?=.*[a-zA-Z])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{8,20}$'})}
                        aria-invalid={errors.firstName ? "true" : "false"}
                        className="invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer w-[405px] px-4 h-11 border border-slate-500 rounded focus:border-sky-600 focus:outline-none focus:ring focus:ring-sky-400 focus:ring-opacity-40"
                        placeholder="Username"
                    />
                ...
                <button type="submit" className="mt-6 group-invalid:pointer-events-none group-invalid:opacity-30 w-[405px] bg-sky-600 text-white font-semibold h-12 rounded hover:bg-sky-700 focus:border-sky-600 focus:outline-none focus:ring focus:ring-sky-400 focus:ring-opacity-40">Submit</button>
            </form>
        </>
    );
};
