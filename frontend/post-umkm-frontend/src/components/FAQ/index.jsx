...
const FaqSection = () => {
    ...
    return (
        <section className="min-h-screen py-10 sm:py-16 lg:pt-24 pb-48 mb-16 dark:bg-gray-900">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="font-bold leading-tight text-blue-950 text-4xl lg:text-5xl dark:text-neutral-50">
                ...
                <div className="max-w-4xl mx-auto mt-8 space-y-4 md:mt-16">
                    {faq.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                <span className="flex text-left text-base md:text-lg font-semibold text-black dark:text-neutral-50 col-span-11">
                                    {" "}
                                    {item.question}{" "}
                                </span>

                                <svg
                                    className={`col-span-1 w-6 h-6 text-gray-400 flex flex-row justify-self-end ${
