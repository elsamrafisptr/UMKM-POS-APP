        ...
        <section className="mx-auto bg-blue-100">
            ...
            <div className="h-screen bg-gradient-to-br from-blue-700 to-sky-400 pt-16 md:pt-24 pb-6 grid grid-rows-2 gap-12">
                <div className="mt-12 md:mt-6 px-5 md:px-16">
                    ...
                    <p className=" text-base md:text-lg py-2 text-gray-100 max-w-2xl">
                        Aplikasi Kasir dan Analisis usaha gratis untuk
                        mempermudah dan meningkatkan kualitas UMKM di Indonesia.
                    </p>
                    <div className="mt-6 md:py-6 md:mb-6">
                        <Link
                            href={"/signin"}
                            className="font-semibold rounded text-blue-700 px-5 py-3 bg-white mr-2"
                        >
                            Ayo Mulai Sekarang
                        </Link>
                        <Link
                            href={"/"}
                            className="font-medium rounded-lg px-5 py-3 text-white "
                        >
                            Tonton Video Demo
                        </Link>
                    </div>
            ...
            <section className="pt-40 px-5 md:px-16">
                <div className="flex flex-col">
                    ...
                    <div className="mt-12 md:mt-24 grid grid-cols-1 md:grid-cols-2">
                        <span className="">
                            ...
                            <p className="mt-4">
                                ...
                                adipisicing elit. Et soluta vero rem. Lorem
                                ipsum dolor sit, amet consectetur adipisicing
                                elit. Cupiditate, praesentium. A odit dolorum et
                                id repellendus.
                            </p>
                        </span>
                    </div>
                    <div className="mt-12 md:mt-24">
                        ...
                        <div className="w-full py-4 grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                            <a
            ...
            {/* Section Feature Produk Start */}
            <div className="mx-auto py-6 px-5 md:px-12">
                <div className="w-full min-h-screen py-12 px-5 md:px-12 bg-gradient-to-tr from-blue-500 to-sky-100 rounded-2xl"></div>
            </div>
            {/* Section Feature Produk End */}
            ...
            <footer className="bg-gray-500 relative">
                ...
                <div className="mx-auto w-full px-5 md:px-16 absolute -top-32">
                    <div className="w-full py-12 px-5 md:px-12 bg-gradient-to-tr from-blue-800 to-sky-400 rounded-2xl">
                        <h2 className="text-4xl font-semibold flex text-white max-w-lg leading-tight">
                            Mulai bergabung sekarang, GRATIS!
                        </h2>
                        <p className="text-gray-100 mt-2 max-w-xl">
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Possimus nemo eos.
                        </p>
                        <div className="mt-6">
                            <Link
                                href={"/signup"}
                                className="px-6 py-3 rounded cursor-pointer capitalize font-semibold text-blue-700 hover:text-white duration-200 bg-white hover:bg-slate-800"
                            >
